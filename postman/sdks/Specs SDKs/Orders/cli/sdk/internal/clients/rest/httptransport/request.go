...
import (
	...
	"example.com/orders/sdk/internal/contenttypes"
	"example.com/orders/sdk/internal/serialization"
	"example.com/orders/sdk/internal/utils"
...
func NewRequest(ctx context.Context, method string, path string, config orderssdkconfig.Config) Request {
	return Request{
		Context:             ctx,
		Method:              method,
		Path:                path,
