...
func NewRequestBuilder() *RequestBuilder {
	...
	rb.request.SetHeader("User-Agent", "postman-codegen/2.7.0 orderssdk/1.0.0 (go)")
	return rb
}
...
// Returns the builder for method chaining.
func (rb *RequestBuilder) WithConfig(config orderssdkconfig.Config) *RequestBuilder {
