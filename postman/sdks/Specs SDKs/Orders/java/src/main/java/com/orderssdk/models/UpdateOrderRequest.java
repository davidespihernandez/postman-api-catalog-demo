...
public class UpdateOrderRequest {
  ...
  @NonNull
  private UpdateOrderRequestStatus status;
  ...
  public static class UpdateOrderRequestBuilder {
    ...
    @JsonProperty("currency")
    public UpdateOrderRequestBuilder currency(String value) {
      if (value == null) {
    ...
    @JsonAnySetter
    public UpdateOrderRequestBuilder additionalProperties(String key, Object value) {
